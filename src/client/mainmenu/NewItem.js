        ...
        <div id="workingPane">
          ...
          <form onSubmit={this.rfa_onSubmit}>
            ...
            <Input
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.brand}
            />
            <Input
              name="description"
              label="Description"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.description}
            />
            <Input
              name="units"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.units}
            />
            <Input
              name="par"
              label="Par"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.par}
            />
            <Input
              name="instock"
              label="In Stock"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.instock}
            />
            <Input
              name="storage"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.storage}
              lsr={this.state.lsrstorage}
            />
            <Input
              name="store"
              label="Grocery Store"
              ...
              onChange={this.rfa_onChange}
              error={this.state.userNotify.store}
              lsr={this.state.lsrstore}
            />
            <Input
              name="instore_location"
              label="In-Store Location"
              value={this.state.instore_location}
              onChange={this.rfa_onChange}
              error={this.state.userNotify.instore_location}
            />
